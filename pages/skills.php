...
<section class="skills-section py-5 mt-5 flex-grow-1">
    ...
    <div class="container">
        <div class="text-center mb-5 reveal">
            ...
            <h1 class="display-4 fw-bold"><span class="text-primary">My</span> <span class="text-gradient">Skills</span></h1>
            <p class="text-muted mt-3 col-lg-6 mx-auto">A showcase of my <span class="text-purple">technical abilities</span> and the technologies I work with to bring <span class="text-purple">ideas to life</span>.</p>
        </div>
        ...
        <div class="mb-5 reveal">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="mb-0">Programming <span class="text-purple">Languages</span></h3>
        ...
        <div class="mb-5 reveal">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="mb-0">Frontend <span class="text-purple">Technologies</span></h3>
        ...
        <div class="mb-5 reveal">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="mb-0">Tools & <span class="text-purple">Technologies</span></h3>
